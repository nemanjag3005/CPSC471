  ...
  async function getLocations() {
    try {
      const response = await fetch(
        "http://localhost:5000/dashboard/locations",
        {
          method: "GET",
        }
      );
                  ...
                  <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                    ...
                    <div className="py-4">
                      <div className="mt-5 flex items-center">
                        <button
                          onClick={() => checkIn()}
                          className="flex mx-auto items-center justify-center rounded-md border border-transparent bg-gray-600 px-8 py-3 text-base font-medium text-red-600 hover:bg-gray-200 md:py-4 md:px-10 md:text-lg"
                        >
                          Check In
                        </button>
                        <button
                      ...
                      <h1 className="text-xl mt-12 font-semibold text-gray-200">
                        Locations
                      </h1>
                      <div className="grid grid-cols-3 gap-6 mt-6">
                        {locations.map((location) => (
                          <div
                            key={location}
                            className="rounded-xl bg-gray-800 shadow-xl p-5"
                          >
                      ...
                      <div className="rounded-xl bg-gray-800 flex flex-col items-center shadow-xl mt-6 p-5">
