  ...
  async function getUserinfo() {
    try {
      ...
      const response2 = await fetch(
        "http://localhost:5000/dashboard/admintype",
        {
          method: "GET",
          headers: {
            token: localStorage.token,
                  ...
                  <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                    ...
                    <div className="py-4">
                      <div className="rounded-xl py-8 w-full px-4 w-xl flex flex-col justify-center shadow-xl bg-gray-800">
                        <h1 className="text-2xl  font-bold px-8 text-gray-200 mb-6">
                          {userinfo.firstname} {userinfo.lastname}
                        </h1>
                        <h1 className="text-3xl font-bold px-8 text-red-700">
                          {employeetype}
                        </h1>
