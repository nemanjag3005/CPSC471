...
const WorkoutBookings = () => {
  ...
  async function create(data) {
    ...
    try {
      const response = await fetch(
        "http://localhost:5000/dashboard/createworkout",
        {
          method: "POST",
          headers: {
  ...
  async function removeWorkout(id) {
    try {
      const response = await fetch(
        "http://localhost:5000/dashboard/deleteworkout",
        {
          method: "DELETE",
          headers: {
            token: localStorage.token,
                    ...
                    <div className="py-4">
                      {bookings.map((booking) => (
                        ...
                        >
                          ...
                          <button
                            onClick={() => removeWorkout(booking.bid)}
...
export default WorkoutBookings;
